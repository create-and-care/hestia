module Ui
  class TextareaComponent < ApplicationComponent
    def initialize(name: nil, placeholder: nil, rows: 4, disabled: false, invalid: false, html_options: {})
      @name = name
    ...
    def call
      content_tag :textarea, content, name: @name, placeholder: @placeholder, rows: @rows, disabled: @disabled,
        ...
        **@html_options.except(:class),
        class: cn(
          "flex w-full rounded-md border bg-container px-3 py-2 text-sm text-primary placeholder:text-subdued",
