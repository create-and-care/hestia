module Ui
  class CheckboxComponent < ApplicationComponent
    ...
    def call
      tag.span class: "relative inline-flex size-[18px]" do
        tag.input(
          type: "checkbox", name: @name, id: @id, checked: @checked, disabled: @disabled,
          class: cn(
            "peer size-[18px] shrink-0 appearance-none rounded-sm border border-primary bg-container",
        ...
        tag.svg(viewBox: "0 0 16 16", fill: "none",
          class: "pointer-events-none absolute inset-0 size-[18px] p-0.5 text-inverse opacity-0 peer-checked:opacity-100") {
